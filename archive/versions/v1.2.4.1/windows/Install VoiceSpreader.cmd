...
set "ROOT=%~dp0"
set "PACKAGE=%ROOT%VoiceSpreader-v{{VERSION}}-x64.msix"
set "HASH_FILE=%PACKAGE%.sha256"
set "CERT=%ROOT%VoiceSpreader-v{{VERSION}}.cer"
...
echo Importing the self-signed certificate and installing VoiceSpreader...
...
echo VoiceSpreader v{{VERSION}} installed successfully.
exit /b 0
